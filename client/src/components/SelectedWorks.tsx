...
function SelectedWorks() {
  ...
  return (
    <div className="flex flex-col gap-3 w-full min-h-[100vh] px-16 mt-28 text-textColor">
      <div className="flex w-full px-1 justify-between items-center h-max">
        <p className="text-3xl font-poppins font-light">SELECTED WORKS</p>
        <div className="flex items-center gap-3">
          ...
          <p className="text-base font-poppins font-light">SEE ALL</p>
        </div>
      </div>
